defmodule MazeeWeb.Endpoint do
  ...
  defp handle_preflight(%Plug.Conn{method: "OPTIONS"} = conn, _opts) do
    ...
    |> Plug.Conn.put_resp_header("access-control-allow-methods", "GET, POST, PATCH, PUT, DELETE, OPTIONS")
    |> Plug.Conn.put_resp_header("access-control-allow-headers", "authorization, content-type, accept")
